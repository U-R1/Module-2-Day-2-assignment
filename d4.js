...
/* 1. Number:       can be any number
   2. String:       sequence of characters, can type text with it 
   3. Boolean:      true or false
   4. Undefined:    variable which hasn't been assigned any value 
   5. Null:         can empty the value of a variable*/
...
Group of variables that describe the same entity*/
